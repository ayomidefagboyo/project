...
import { CreateVendorData } from '@/lib/vendorService';
...
const CreateVendorModal: React.FC<CreateVendorModalProps> = ({ onClose, onSubmit }) => {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white ${
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => handleInputChange('vendorType', e.target.value as VendorType)}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => handleInputChange('creditLimit', e.target.value ? parseFloat(e.target.value) : undefined)}
                  className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white ${
                    errors.creditLimit ? 'border-red-500' : 'border-gray-300 dark:border-gray-500'
                  }`}
                  placeholder="0.00"
                />
                {errors.creditLimit && (
