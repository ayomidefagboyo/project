...
from app.api.v1.endpoints import auth, vendors, outlets, invoices, expenses, reports, users, audit, payments, ocr, anomalies, stripe_payments
# Temporarily disabled: eod
...
# Temporarily disabled: api_router.include_router(eod.router, prefix="/eod", tags=["EOD Reports"])
