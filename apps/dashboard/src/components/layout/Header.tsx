          ...
          <div className="flex items-center justify-between gap-2">
            ...
            <div className="flex items-center gap-1 sm:gap-2">
              <a
                ...
                className="hidden lg:flex items-center space-x-2 px-4 py-2 bg-orange-600 hover:bg-orange-700 text-white rounded-lg transition-colors font-medium text-sm"
              >
              ...
              <div className="relative">
                <button
                  ...
                  className="flex items-center space-x-2 px-2 sm:px-3 py-2 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors group"
                >
                ...
                {isUserMenuOpen && (
                  <div className="absolute right-0 mt-2 w-64 max-w-[calc(100vw-2rem)] bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 py-2 z-50">
