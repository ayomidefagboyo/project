...
const CreateVendorModal: React.FC<CreateVendorModalProps> = ({ onClose, onSubmit }) => {
  const initialData: CreateVendorData = {
    business_name: '',
    contact_person: '',
    email: '',
    phone: '',
  ...
  const [formData, setFormData] = useState<CreateVendorData>(initialData);
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white ${errors.business_name ? 'border-red-500' : 'border-gray-300'
                    }`}
