...
3. Copy the generated API key (it looks like: `AIzaSyDaGmWuGao4Es1QcUyuaZrfQs1X2Y3Z4B5`)
...
VITE_GOOGLE_VISION_API_KEY=AIzaSyDaGmWuGao4Es1QcUyuaZrfQs1X2Y3Z4B5
```

#### **Backend (backend/.env):**
```bash
# Google Cloud Vision API for OCR
GOOGLE_VISION_API_KEY=AIzaSyDaGmWuGao4Es1QcUyuaZrfQs1X2Y3Z4B5
```
